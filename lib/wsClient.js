...
const instAtTime = require('./instructions-at-time');
...
const mousePlugin = (event, pstate) => {
  console.log('mouse pluging');
  instAtTime(event, pstate, websocket);
};
module.exports = { init, wsRenderPlugin, keyPlugin, mousePlugin, setup };
