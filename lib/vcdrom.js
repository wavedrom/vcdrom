...
<form class="form">
  <div class="shortcut-helper-menu hidden">
    ...
    <div class="shortcut">
      <div class="label">Move Up / Move Down</div>
      <div class="key-command">
        <span class="key key-16"> <big><b> &#8593; / &#8595; </big> </b> </span>
      </div>
    </div>
        <div class="shortcut">
      <div class="label">Page Up / Page Down</div>
      <div class="key-command">
        <span class="key key-16">page up / page down</span>
      </div>
    </div>
    <div class="shortcut">
      <div class="label">Move Right / Left</div>
      <div class="key-command">
        <span class="key key-16"><big><b>&#8594; / &#8592;</big> </b></span>
      </div>
    </div>
          <div class="shortcut">
      <div class="label">Zooms in/out/All</div>
      <div class="key-command">
        <span class="key key-16"><b> &#x2b; / &#x2212; <b> / F</span>
      </div>
    </div>
              <div class="shortcut">
      <div class="label">Goto Start /End</div>
      <div class="key-command">
        <span class="key key-16">home / end</span>
      </div>
    </div>
    <div class="shortcut">
    ...
    <div class="shortcut">
      ...
      <div class="key-command">
        <span class="key key-16"><b>SHIFT + <span class="key key-39">a-b</span></b></span>
      </div>
    </div>
    <div class="shortcut">
      <div class="label">Goto Marks </div>
      <div class="key-command">
        <span class="key key-16"><b>a/b c/d</b></span>
      </div>
    </div>
    <div class="shortcut">
      <div class="label">Toggle Cursor Mode </div>
      <div class="key-command">
        <span class="key key-16"><b>m</b></span>
      </div>
    </div>
...
document.addEventListener('keydown', (event) => {
  if (event.key == '/' || event.key == '?') {
    if (state == 0) {
      console.log(' the event listener is clicked');
