...
module.exports = (content, desc /* , opt */) => {
  ...
  els.container.addEventListener('keydown', genKeyHandler(content, els.cursor, pstate, render, cm, ws));
  els.container.addEventListener('wheel', genOnWheel(content, els.cursor, pstate, render, cm, ws));
