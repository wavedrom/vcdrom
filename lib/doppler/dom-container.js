...
const cursorXMargin = 40;
const cursorFontHeight = 20;
const cursorFontWidth = cursorFontHeight / 2;
...
const setupMouseHandlers = (cursor, content, pstate /* , render */) => {
  const moveHandler = event => {
    ...
    cursor.style.left = (x - cursorXMargin) + 'px';
    cursor.innerHTML = renderCursor({xmargin: cursorXMargin, fontWidth: cursorFontWidth, fontHeight: cursorFontHeight}, pstate);
  };
...
module.exports = (content, desc /* , opt */) => {
  ...
  const resizeObserver = new ResizeObserver(entries => {
    ...
    render();
    els.cursor.innerHTML = renderCursor({ xmargin: cursorXMargin, fontWidth: cursorFontWidth, fontHeight: cursorFontHeight }, pstate);
