...
module.exports = {
  ...
  Home: (pstate) => {
    ...
    pstate.xOffset = sidebarOffset;
    //console.log('xOffset=' + sidebarOffset);
    return true;
  },
  End: (pstate) => {
    ...
    //console.log('xOffset=' + xOffsetMin);
    return true;
  },
  ArrowLeft: (pstate) => {
    let { xOffset, sidebarOffset } = pstate;
    ...
    pstate.xOffset = xOffset;
    //console.log('time=' + pstate.time + '  xOffset=' + pstate.xOffset);
    return true;
  },
  ArrowRight: (pstate) => {
  ...
  PageDown: down(1),
  Insert: (pstate) => {
    pstate.xOffset = xOffsetAtT(10190, pstate);
    return true;
  },
